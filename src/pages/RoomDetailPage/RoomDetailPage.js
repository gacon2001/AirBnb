        ...
        <div className="w-[1120px] mx-auto">
          <div className="pt-6">
            <h2 className="text-2xl font-semibold text-left">
              Apartment rentals near Embassy of Japan and Lotte
            </h2>
              ...
              <div className="left1 flex flex-row justify-between items-center pb-6 border-b ">
                <div className="text-left">
                  ...
                  <span className="text-lg font-light text-gray-700  ">
                    ...
                    <span> 1 bed </span> • <span> 1 bath</span>
                  </span>
                </div>
              ...
              <div className="left2 flex flex-col py-6 border-b ">
                <div className="flex flex-row items-center py-3">
                  ...
                  <div className="w-11/12 content text-left">
                    <h3 className="text-xl font-semibold mb-1">Toàn bộ nhà</h3>
              ...
              <div className="left3 py-6 border-b text-left ">
                <div className="h-44 w-full overflow-hidden mb-3 text-ellipsis whitespace-normal">
                  <p className="font-light tracking-wide text-gray-700 mt-2 text-justify">
                    This adorable studio is perfectly located in the center of
                    Ho Chi Minh, reaching to most highlight city spots within
                    literally 5 mins walking distance. From food shops to cafes,
                    from gym to rooftop garden, everything here is designed to
                    make your experience both enjoyable and fun at the same
                    time, you will just love your stay! The space This cosy
                    studio is extremely convenient for both tourist trips and
                    business visits to HCM. You can visit nearby famous
                    attractions, popular restaurants, bars and shops in
                    literally 5 mins walk from this condo. With a relaxing and
                    cozy ambience, this will be your ideal base to experience
                    the vibrant and sparkling life in one of the fastest growing
                    cities in Asia !!! General Description:
                  </p>
                </div>
            ...
            <div className="right w-2/5 h-[1190px] ml-[8.3%] relative">
              <div className="sticky top-0 w-full pb-12">
                    ...
                    <div className="border border-gray-900 rounded-xl">
                      <div className="date flex ">
                        ...
                        <div className="checkOut w-1/2 pl-6 py-4 ">
                          <h4 className="text-sm font-bold pb-2">CHECK OUT</h4>
                          <span>12/8/2022</span>
                        </div>
                      </div>
                ...
                <div className="note underline cursor-pointer font-semibold text-sm mt-8">
                  <FontAwesomeIcon icon={faFlag} className="mr-5" /> Report this
                  listing
                </div>
              </div>
            </div>
            ...
            <div className="bottom flex flex-col flex-wrap h-[600px]">
              <div className="w-1/2 h-40 pr-14 my-5">
                ...
                <div className="reviewBottom h-16 text-ellipsis overflow-hidden whitespace-normal ">
                  <span>
                    Managing Hanoi apartments for rent in the largest urban area
                    in Vietnam Vinhomes Ocean Park, Sora-Inn Apartments near
                    Lotte building and Embassy of Japan, Bella resort beside Ba
                    Vi nation park, Vinhomes Green Bay, The garden The
                    Manor,Sora-Inn Apartments near Lotte building and Embassy of
                    Japan, Bella resort beside Ba Vi nation park, Vinhomes Green
                    Bay, The garden The Manor,..
                  </span>
                </div>
              </div>
              <div className="w-1/2 h-40 pr-14 my-5">
