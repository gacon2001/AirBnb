...
const RegistrationPage = () => {
  ...
  return (
    <div>
      ...
      <div className="login absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[480px] md:w-2/3 lg:w-4/5 lg:h-4/5 bg-white shadow-lg lg:scale-100 scale-90 rounded-md overflow-hidden grid grid-rows-3  lg:grid-flow-col lg:grid-cols-3 lg:grid-rows-none">
        <div className="img overflow-hidden lg:row-span-2 hidden lg:block ">
          <img
            src={bgImg}
            alt=""
        ...
        <div className="form p-12 row-span-3 lg:row-span-2 lg:col-span-2 flex flex-col justify-center lg:overflow-hidden z-20">
          <div className="title flex justify-between md:flex-row flex-col">
            <h2 className="font-light text-5xl inline-block mb-5">
              Registration
            </h2>
            <div>
          ...
          <div className="formInput ">
            <Form
              ...
              className="lg:py-12"
            >
              <div className="pt-12 lg:py-12 grid grid-flow-row lg:grid-cols-2 lg:grid-flow-row gap-3">
                <Form.Item
                  name="name"
                  rules={[
                    {
              ...
              <Form.Item>
                <Button
                  className=" loginButton py-2 h-max w-max px-12 text-xl font-medium rounded-md border border-gray-200 hover:border-gray-500 cursor-pointer text-white"
                  htmlType="submit"
                >
                  Registration
                </Button>
