...
const RegistrationPage = () => {
  ...
  return (
    <div>
      ...
      <div className="login absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-3/5 h-4/5 bg-white shadow-lg lg:scale-100 md:scale-100 sm:scale-95 scale-90 rounded-md overflow-hidden grid grid-flow-col grid-cols-3">
        ...
        <div className="form p-12 col-span-2 flex flex-col justify-center">
          <div className="title flex justify-between">
            <h2 className="font-light text-5xl inline-block">Registration</h2>
            <div>
